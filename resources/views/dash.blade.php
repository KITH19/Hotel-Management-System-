...
.info-container p {
    font-size: 36px;
    font-weight: bold;
    color: #0E4BF1; /* Adjust the color as needed */
}
...
<body>
    <nav>
        <div class="logo-name">
            ...
            <span class="logo-name"><img src="/images/logo.png" height=70px width=100px alt="Your Logo"></span>
        </div>
    ...
    <div class="info-container">
        <h2>Classic Rooms</h2>
        <p>{{ $totalClassicRooms }}</p>
    </div>
    <div class="info-container">
        <h2>Deluxe Rooms</h2>
        <p>{{ $totalDeluxeRooms }}</p>
    </div>
    <div class="info-container">
        <h2>Luxury Rooms</h2>
        <p>{{ $totalLuxuryRooms }}</p>
    </div>
...
@endif
<!-- Include the login link if the user is not authenticated -->
@if(!Auth::check())
    <a href="{{ route('login') }}">Login</a>
@else
    <!-- Include the logout form if the user is authenticated -->
